                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('get_anggota') }}" class="btn btn-primary">kirim</a>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('get_buku') }}" class="btn btn-primary">kirim</a>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h6 class="card-title">Lorem ipsum dolor sit amet.</h6>
                                    <p class="card-text">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptatibus, asperiores!</p>
                                    <a href="{{ route('get_petugas') }}" class="btn btn-primary">kirim</a>
                                </div>
                            </div>
                        </div>
                        <!-- /.col-md-6 -->
